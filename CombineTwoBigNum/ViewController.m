...
- (void)viewDidLoad {
    ...
    NSString *one = @"123344567891891212497139";
    NSString *two = @"372493759239572975473438";
    
    NSString *result = [self addTwoNumberWithOneNumStr:one anotherNumStr:two];
